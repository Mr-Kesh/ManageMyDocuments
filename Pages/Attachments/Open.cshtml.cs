...
public class OpenModel : AuthenticatedPageModel
{
    private readonly AppDb _db;
    private readonly FileStorageService _files;

    public OpenModel(AppDb db, FileStorageService files)
    {
        _db = db;
        _files = files;
    }
    ...
    public async Task<IActionResult> OnGetAsync(int id)
    {
        ...
        return PhysicalFile(absolutePath, attachment.AttachmentType);
    }
}